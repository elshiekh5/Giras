...
$(function() {
    ...
    $(".datepicker-icon").datepicker({
        showOn: "button",
        buttonImage: "/Layout2/RTL/assets/images/ui/datepicker_trigger.png",
    ...
    $("#ac-remote").autocomplete({
        minLength: 2,
        source: "/Layout2/RTL/assets/demo_data/jquery_ui/autocomplete.php",
        search: function() {
    ...
    $("#ac-caching").autocomplete({
        ...
        source: function(request, response) {
            ...
            $.getJSON("/Layout2/RTL/assets/demo_data/jquery_ui/autocomplete.php", request, function(data, status, xhr) {
                cache[ term ] = data;
                response(data);
            });
        },
