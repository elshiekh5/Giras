<%@ Page language="c#" MasterPageFile="~/AdminCP/ClearAdmin.master" CodeFile="default.aspx.cs" Inherits="AdminUsersDataGlobalOptions_GetAll"  %><%@ Register Assembly="MoversFW" Namespace="MoversFW" TagPrefix="cc1" %>
			...
			<table class="SubTable" cellspacing="0" cellpadding="0" width="100%" border="0" >
				...
				<tr>
					<td class="GridControl" align="center" colspan="2">
						<asp:DataGrid id="dgUsersDataGlobalOptions" runat="server" SkinId="GridViewSkin" 
						OnDeleteCommand="dgUsersDataGlobalOptions_DeleteCommand" OnItemDataBound="dgUsersDataGlobalOptions_ItemDataBound" 
						OnEditCommand="dgUsersDataGlobalOptions_EditCommand" >
						<Columns>
