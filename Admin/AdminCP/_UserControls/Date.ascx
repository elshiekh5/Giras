<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Date.ascx.cs" Inherits="UserControls_Date" %>
        ...
        <div class="col-lg-2">
            <asp:DropDownList ID="ddlDay" runat="server" CssClass="form-control" Width="70">
        ...
        <div class="col-lg-2">
            <asp:DropDownList ID="ddlMonth" runat="server" CssClass="form-control" Width="70">
       ...
       <div class="col-lg-2">
            <asp:TextBox MaxLength="4" ID="txtYear"   runat="server" CssClass="form-control" Width="70"></asp:TextBox>
