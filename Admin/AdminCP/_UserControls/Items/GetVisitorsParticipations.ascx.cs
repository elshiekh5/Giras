...
public partial class Items_AdminGetVisitorsParticipations : System.Web.UI.UserControl
{
    #region --------------ModuleTypeID--------------
    ...
    //------------------------------------------
    #endregion
    #region --------------UnRepliedCondition--------------
    private bool _UnRepliedCondition;
    public bool UnRepliedCondition
    {
        get { return _UnRepliedCondition; }
        set { _UnRepliedCondition = value; }
    }
    //------------------------------------------
    #endregion
    #region --------------NotSeenCondition--------------
    private bool _NotSeenCondition;
    public bool NotSeenCondition
    {
        get { return _NotSeenCondition; }
        set { _NotSeenCondition = value; }
    }
    //------------------------------------------
    #endregion
    #region --------------IsAvailableCondition--------------
    private bool _IsAvailableCondition;
    public bool IsAvailableCondition
    {
        get { return _IsAvailableCondition; }
        set { _IsAvailableCondition = value; }
    }
    //------------------------------------------
    #endregion
    ...
    private void LoadGrid(int categoryID)
    {
        ...
        itemsList = ItemsFactory.GetVisitorsParticipations(ModuleTypeID, langID, categoryID, IsAvailableCondition, IsAvailable, UserId, ToUserId, UnRepliedCondition, NotSeenCondition, pager.CurrentPage, pager.PageSize, out totalRecords, OwnerID);
