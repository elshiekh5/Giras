...
public partial class Items_Update : System.Web.UI.UserControl
{
    ...
    protected void HandleOptionalControls()
    {
        ...
        //-----------------------------------
        //Previews
        btnDeletePhoto.Visible = !currentModule.RequiredPhoto;
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        {/*
                ...
                if (!SiteSettings.CheckUploadedFileExtension(uploadedFileExtension, currentModule.FileAvailableExtension))
                {
                    ...
                    General.MakeAlertError(lblResult, Resources.AdminText.NotSuportedFileExtention + currentModule.FileAvailableExtension);
            ...
            {
                General.MakeAlertError(lblResult, Resources.AdminText.UploadedFileGreaterThanMaxLength + currentModule.FileMaxSize);
                return;
            }
        }
        //-----------------------------------------------------------------
        ...
        {/*
                ...
                if (!SiteSettings.CheckUploadedFileExtension(uploadedVideoExtension, currentModule.VideoAvailableExtension))
                {
                    ...
                    General.MakeAlertError(lblResult, Resources.AdminText.NotSuportedVideoExtention + currentModule.VideoAvailableExtension);
            ...
            {
                General.MakeAlertError(lblResult, Resources.AdminText.UploadedVideoGreaterThanMaxLength + currentModule.VideoMaxSize);
                return;
            }
        }
        //-----------------------------------------------------------------
        ...
        {/*
                ...
                if (!SiteSettings.CheckUploadedFileExtension(uploadedAudioExtension, currentModule.AudioAvailableExtension))
                {
                    ...
                    General.MakeAlertError(lblResult, Resources.AdminText.NotSuportedAudioExtention + currentModule.VideoAvailableExtension);
            ...
            if (!SiteSettings.CheckUploadedFileLength(fuAudio.PostedFile.ContentLength, currentModule.AudioMaxSize))
            {
                ...
                General.MakeAlertError(lblResult, Resources.AdminText.UploadedAudioGreaterThanMaxLength + currentModule.AudioMaxSize);
        ...
        if (fuPhoto2.HasFile)
        {
            if (!MoversFW.Photos.CheckIsImage(fuPhoto2.PostedFile))
            {
                ...
                if (!SiteSettings.CheckUploadedFileExtension(uploadedPhoto2Extension, currentModule.Photo2AvailableExtension))
                {
                    ...
                    General.MakeAlertError(lblResult, Resources.AdminText.NotSuportedFileExtention + currentModule.Photo2AvailableExtension);
            ...
            if (!SiteSettings.CheckUploadedFileLength(fuPhoto2.PostedFile.ContentLength, currentModule.Photo2MaxSize))
            {
                ...
                General.MakeAlertError(lblResult, Resources.AdminText.UploadedFileGreaterThanMaxLength + currentModule.Photo2MaxSize);
        ...
        if (status == ExecuteCommandStatus.Done)
        {
            ...
            {
                General.MakeAlertSucess(lblResult, Resources.AdminText.UpdatingsOperationDone);
        ...
        else
        {
            ...
            General.MakeAlertError(lblResult, Resources.AdminText.UpdatingOperationFaild);
    ...
    protected void LoadDetailsControls(MLanguagesDetailsControls ucDetails)
    {
        ...
        fckDescription = (TextBox)ucDetails.FindControl("fckDescription");
