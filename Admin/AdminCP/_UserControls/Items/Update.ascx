<%@ Control Language="c#" AutoEventWireup="true" CodeFile="Update.ascx.cs" Inherits="Items_Update" %>
    ...
    <div class="panel panel-flat">
        ...
        <div class="panel-body">
            ...
            <div class="form-group" id="trCategoryID" runat="server">
                ...
                <div class="col-lg-9">
                    <asp:DropDownList ID="ddlItemCategories" runat="server" CssClass="select" OnSelectedIndexChanged="ddlItemCategories_SelectedIndexChanged">
                    </asp:DropDownList>
            ...
            <div class="form-group" id="trIcon" runat="server">
                <label class="col-lg-3 control-label">
                    <asp:Label ID="lblIcon" runat="server" />:</label>
                <div class="col-lg-9" style="direction: ltr">
                    ...
                    <select class="select fa" id="ddlFAIcons">
      ...
      fa-youtube-square
            ...
            <div class="form-group" id="trAuthorID" runat="server">
                <label class="col-lg-3 control-label">
                    <asp:Label ID="lblAuthorID" runat="server" />
                    :</label>
                <div class="col-lg-9">
                    <asp:DropDownList ID="ddlAuthorID" runat="server" CssClass="select" ValidationGroup="Items">
                    </asp:DropDownList>
                </div>
            </div>
            ...
            <div class="form-group" id="trItemEndDate" runat="server">
                <label class="col-lg-3 control-label">
            ...
            <div class="form-group" id="trMailBox" runat="server">
                <label class="col-lg-3 control-label">
                    ...
                    :</label>
                <div class="col-lg-9">
                    <asp:TextBox MaxLength="64" ID="txtMailBox" runat="server" CssClass="form-control"></asp:TextBox>
            ...
            <div class="form-group" id="trZipCode" runat="server">
                <label class="col-lg-3 control-label">
                    ...
                    :</label>
                <div class="col-lg-9">
                    <asp:TextBox MaxLength="64" ID="txtZipCode" runat="server" CssClass="form-control"></asp:TextBox>
                    <asp:RequiredFieldValidator ValidationGroup="Items" ID="rfvZipCode" ControlToValidate="txtZipCode"
                        Display="Dynamic" runat="server" ErrorMessage="*" Text="*"></asp:RequiredFieldValidator>
                </div>
            </div>
            <div class="form-group" id="trTels" runat="server">
                <label class="col-lg-3 control-label">
                    <asp:Label ID="lblTels" runat="server" />
                    :</label>
                <div class="col-lg-9">
                    <asp:TextBox MaxLength="64" ID="txtTels" runat="server" CssClass="form-control"></asp:TextBox>
                    <asp:RequiredFieldValidator ValidationGroup="Items" ID="rfvTels" ControlToValidate="txtTels"
                        Display="Dynamic" runat="server" ErrorMessage="*" Text="*"></asp:RequiredFieldValidator>
                </div>
            </div>
            <div class="form-group" id="trMobile" runat="server">
                <label class="col-lg-3 control-label">
                    <asp:Label ID="lblMobile" runat="server" />
                    :</label>
                <div class="col-lg-9">
                    <asp:TextBox MaxLength="64" ID="txtMobile" runat="server" CssClass="form-control"></asp:TextBox>
            ...
            <div class="form-group" id="trFax" runat="server">
                <label class="col-lg-3 control-label">
                    ...
                    :</label>
                <div class="col-lg-9">
                    <asp:TextBox MaxLength="64" ID="txtFax" runat="server" CssClass="form-control"></asp:TextBox>
            ...
            <div class="form-group" id="trUrl" runat="server">
                <label class="col-lg-3 control-label">
                    ...
                    :</label>
                <div class="col-lg-9">
                    <asp:TextBox MaxLength="128" ID="txtUrl" runat="server" CssClass="form-control"></asp:TextBox>
            ...
            <div class="form-group" id="trEmail" runat="server">
                <label class="col-lg-3 control-label">
                    ...
                    :</label>
                <div class="col-lg-9">
                    <asp:TextBox MaxLength="128" ID="txtEmail" runat="server" CssClass="form-control"></asp:TextBox>
            ...
            <div class="form-group" id="trPriority" runat="server">
                <label class="col-lg-3 control-label">
                    ...
                    :</label>
                <div class="col-lg-9">
                    <asp:DropDownList ID="ddlPriority" runat="server" CssClass="select">
                    </asp:DropDownList>
                </div>
            </div>
            <div class="form-group" id="trHasIsMain" runat="server">
                <label class="col-lg-3 control-label">
                    ...
                    :</label>
                <div class="col-lg-9">
                    <asp:CheckBox ID="CbIsMain" CssClass="form-control" runat="server"></asp:CheckBox>
                </div>
            </div>
            <div class="form-group" id="trHasSpecialOption" runat="server">
                <label class="col-lg-3 control-label">
                    <asp:Label ID="lblSpecialOption" runat="server" />
                    :</label>
                <div class="col-lg-9">
                    <asp:CheckBox ID="cbSpecialOption" CssClass="form-control" runat="server"></asp:CheckBox>
                </div>
            </div>
            <div class="form-group" id="trIsAvailable" runat="server">
                <label class="col-lg-3 control-label">
                    ...
                    :</label>
                <div class="col-lg-9">
                    <asp:CheckBox ID="cbIsAvailable" Checked="true" CssClass="form-control" runat="server"></asp:CheckBox>
                </div>
            </div>
            <div class="form-group" id="trOnlyForRegisered" runat="server">
                <label class="col-lg-3 control-label">
                    ...
                    :</label>
                <div class="col-lg-9">
                    <asp:CheckBox ID="cbOnlyForRegisered" Checked="false" CssClass="form-control" runat="server"></asp:CheckBox>
                </div>
            </div>
            ...
            <div class="form-group" id="trSenderName" runat="server">
                <label class="col-lg-3 control-label">
                    <asp:Label ID="lblSenderName" runat="server" />
                    :</label>
                <div class="col-lg-9">
                    <asp:TextBox MaxLength="128" ID="txtSenderName" runat="server" CssClass="form-control"
                        ValidationGroup="Items"></asp:TextBox>
            ...
            <div class="form-group" id="trSenderEMail" runat="server">
                <label class="col-lg-3 control-label">
                    <asp:Label ID="lblSenderEMail" runat="server" />
                    :</label>
                <div class="col-lg-9">
                    <asp:TextBox MaxLength="128" ID="txtSenderEMail" runat="server" CssClass="form-control"
                        ValidationGroup="Items"></asp:TextBox>
            ...
            <div class="form-group" id="trSenderCountry" runat="server">
                <label class="col-lg-3 control-label">
                    <asp:Label ID="lblSenderCountry" runat="server" />
                    :</label>
                <div class="col-lg-9">
                    <asp:DropDownList ID="ddlSenderCountry" runat="server" CssClass="select" ValidationGroup="Items" />
            ...
            <div class="form-group" id="trToUserID" runat="server">
                   <label class="col-lg-3 control-label">
                    ...
                    :</label>
                    <div class="col-lg-9">
                        <asp:DropDownList ID="ddlToUserID" runat="server" CssClass="select" ValidationGroup="Items" />
                   </div>
                </div>

            <div class="form-group" id="trIsReviewed" runat="server">
                   <label class="col-lg-3 control-label">
                        <asp:Label ID="lblIsReviewed" runat="server" />
                    :</label>
                    <div class="col-lg-9">
                        <asp:CheckBox ID="cbIsReviewed" CssClass="Controls" runat="server"></asp:CheckBox>
                   </div>
                </div>
                
            <div class="form-group" id="trReplyText" runat="server">
                    <label class="col-lg-3 control-label">
            ...
            <div class="form-group" id="trReply" runat="server">
                   <div class="col-lg-12">
                        <asp:TextBox ID="txtReply" runat="server" TextMode="MultiLine" CssClass="form-control"
                            ValidationGroup="Items"></asp:TextBox>
