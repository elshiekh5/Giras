<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditData.ascx.cs" Inherits="UsersData_AdminEdit" %>
<%@ Register Src="../Date.ascx" TagName="HijriDate" TagPrefix="uc2" %>
        ...
        <td>
            <table runat="server" id="tblControls" class="SubTable" cellspacing="0" cellpadding="0"
                ...
                <tr id="trPassword" runat="server" visible="false">
                    ...
                    <td class="Control">
                        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="/Website/User/ChangePass.aspx"><%= Resources.MemberShip.ChangePassword %></asp:HyperLink>
                    </td>
                </tr>
                <tr id="trName" runat="server">
                 ...
                 <tr id="trEmail" runat="server">
                    ...
                    <td class="Control">
                        <asp:TextBox MaxLength="128" ID="txtEmail" ReadOnly="true" runat="server" CssClass="Controls" ValidationGroup="UsersData"></asp:TextBox>
                    </td>
                </tr>
                ...
                <tr id="trCountryID" runat="server">
                    ...
                    <td class="Control">
                        <asp:DropDownList ID="ddlSystemCountries" runat="server" CssClass="Controls" ValidationGroup="UsersData" onselectedindexchanged="ddlSystemCountries_SelectedIndexChanged" >
                        </asp:DropDownList>
                ...
                <tr id="trPhotoExtension" runat="server">
                    <td class="text">
                        <asp:Label ID="lblPhotoExtension" runat="server" Text="<%$ Resources:UsersData,PhotoExtension %>" />
                    </td>
                    <td class="Control">
                        <asp:FileUpload ID="fuPhoto" runat="server" CssClass="Controls" />
                        <asp:RequiredFieldValidator CssClass="ourvalidation" ValidationGroup="UsersData" ID="rfvPhoto"
                            ControlToValidate="fuPhoto" Display="Dynamic" runat="server" ErrorMessage="<%$ Resources:User,RequiredField %>"
