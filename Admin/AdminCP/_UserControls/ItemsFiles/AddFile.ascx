                ...
                <div class="panel-body">
                    ...
                    <div class="form-group" id="trItems" runat="server">
                        <label class="col-lg-3 control-label">
                            <asp:Label ID="lblItems" runat="server" />:</label>
                        <div class="col-lg-9">
                            <asp:DropDownList ID="ddlItems" runat="server" CssClass="Controls"
                                AutoPostBack="True" OnSelectedIndexChanged="ddlItems_SelectedIndexChanged">
                            </asp:DropDownList>
                    ...
                    <div class="form-group" id="TrTitle" runat="server">
                        <label class="col-lg-3 control-label">
                            <asp:Label ID="Label1" Text="<%$ Resources:ItemsFiles,PhotoComment %>" runat="server" />:</label>
                        <div class="col-lg-9">
                    ...
                    <div class="form-group" runat="server">
                        <label class="col-lg-3 control-label">
                            <asp:Label ID="lblFileText" runat="server" Text="<%$ Resources:ItemsFiles,Photo %>" /><span class="RequiredField"><asp:Label ID="Label2" runat="server" Text="*" /></span>:</label>
                        <div class="col-lg-9">
    ...
    <asp:Repeater ID="rPhotos" runat="server" OnItemCommand="rPhotos_ItemCommand" OnItemDataBound="rPhotos_ItemDataBound">
        <ItemTemplate>
            <div class="col-lg-3 col-sm-6">
                <div class="thumbnail">
                    <div class="thumb">
                        <img alt="" src="/Layout2/RTL/assets/images/placeholder.jpg">
                        <div class="caption-overflow">
                            <span>
                                <a class="btn border-white text-white btn-flat btn-icon btn-rounded" rel="gallery" data-popup="lightbox" href="/Layout2/RTL/assets/images/placeholder.jpg"><i class="icon-plus3"></i></a>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="thumbnail">
                    <div class="thumb">
                        ...
                        <div class="caption-overflow">
                            <span>
                                <a class="btn border-white text-white btn-flat btn-icon btn-rounded ml-5" href="<%# ItemsFilesEntity.GetFilePath(Eval("FileID"),Eval("FileExtension"),Eval("OwnerName"),Eval("ModuleTypeID"),Eval("CategoryID"),Eval("ItemID"))%>"><i class="icon-link2"></i></a>
                            </span>
                        </div>
                    </div>
