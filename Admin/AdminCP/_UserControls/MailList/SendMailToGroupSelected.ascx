<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SendMailToGroupSelected.ascx.cs" Inherits="AdminCP__UserControls_MailList_SendMailToGroupSelected" %>
...
<table class="MainTable" cellspacing="0" cellpadding="0" width="100%" border="0" >
			...
			<table class="SubTable" cellspacing="0" cellpadding="0" width="100%" border="0" >
				...
				<tr id="trGroups" runat="server">
					...
					<td class="Control">
						<asp:DropDownList id="ddlMailListGroups" runat="server" CssClass="Controls" 
                            ValidationGroup="MailListEmails" AutoPostBack="True" 
                            onselectedindexchanged="ddlMailListGroups_SelectedIndexChanged"></asp:DropDownList>
				 ...
				 <tr id="trselectedusers" runat="server" visible="true">
                                    <td class="text">
                                        <asp:Label ID="Label4" Text="<%$ Resources:MailListAdmin,MailListUsers %>" runat="server" />
                                    </td>
                                    <td class="Control">
				...
				<tr>
					<td class="text"><asp:Label ID="Label6" Text="<%$ Resources:MailListAdmin,EMailBody %>" runat="server" /><span class="RequiredField"><asp:Label ID="Label8" runat="server" Text="*" /></span></td>
					<td class="Control"></td>
				</tr>
				<tr>
					<td class="Control" colspan="2">
					    
                            <ce:editor id="fckEmailbody" Height="500" Width="600" 
                                EditorWysiwygModeCss="~/CuteSoft_Client/example.css" runat="server" ></ce:editor>
