...
namespace DCCMSNameSpace
{
    ...
    public abstract class AdminAddEditPage : AdminMasterPage
    {
        ...
        //FirstLoad
        //-----------------------------------------------
        protected void FirstLoad(Literal lblResult, Button btnSave)
        {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (status == ExecuteCommandStatus.Done)
            {
                ...
                {
                    General.MakeAlertSucess(lblResult, DynamicResource.GetText("AdminText","SavingDataSuccessfuly"));
                    ClearControls();
                }
            ...
            {
                General.MakeAlertError(lblResult, DynamicResource.GetText("AdminText","DuplicateItem"));
            }
            else
            {
                General.MakeAlertError(lblResult, DynamicResource.GetText("AdminText", "SavingDataFaild"));
            }
