...
namespace DCCMSNameSpace
{
    ...
    public class AdminDefaultPage : AdminMasterPage
    {
        ...
        //----------------------------
        //-----------------------------------------------
        protected void FirstLoad(DataGrid dgControl, OurPager pager, Literal lblResult)
        {
            //----------------------------------------
            //LoadControls
        ...
        protected void LoadGrid(IList list, string dataKeyField)
        {
            ...
            else
            {
                ...
                if (pager != null)
                    pager.Visible = false;
                General.MakeAlertError(lblResult, DynamicResource.GetText("AdminText", "ThereIsNoData"));
            }
        }
        //--------------------------------------------------------
        #endregion
        ...
        public void dgControl_DeleteCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            {
                General.MakeAlertError(lblResult, DynamicResource.GetText("AdminText", "DeletingOprationFaild"));
            }
        }
        //--------------------------------------------------------
        #endregion
