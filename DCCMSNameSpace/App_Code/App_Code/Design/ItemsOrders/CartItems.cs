...
namespace DCCMSNameSpace.ReadyUserControls
{
    ...
    /// </summary>
    public class ItemsOrders_CartItems : ReadyUserControls.UserControl
    {
        #region --------------ModuleTypeID--------------
        ...
        {
            string listOfIds=ShoppingCart.GetListOfItemsIdInCart();
            List<ItemsEntity> itemsList = ItemsFactory.GetInList(listOfIds);
            int quant = 0;
