...
namespace DCCMSNameSpace
{
    public class General
    {
        ...
        #region ----------------MakeAlertError----------------
        //---------------------------------------------
        //AlertError
        //---------------------------------------------
        public static void MakeAlertError(Literal lbl, string message)
        {
            lbl.Text = MakeAlertError(message);
        }
        public static void MakeAlertError(Label lbl,string message)
        {
            lbl.Text= MakeAlertError(message);
        }
        public static string MakeAlertError(string message)
        {
          string alertPattern =   DynamicResource.GetText("AdminText","AlertError");
          return string.Format(alertPattern, message);
        }
        //---------------------------------------------
        #endregion

        #region ----------------MakeAlertSucess----------------
        //---------------------------------------------
        //MakeAlertSucess
        //---------------------------------------------
        public static void MakeAlertSucess(Literal lbl, string message)
        {
            lbl.Text = MakeAlertSucess(message);
        }
        public static void MakeAlertSucess(Label lbl, string message)
        {
            lbl.Text = MakeAlertSucess(message);
        }
        public static string MakeAlertSucess(string message)
        {
            string alertPattern = DynamicResource.GetText("AdminText", "AlertSuccess");
            return string.Format(alertPattern, message);
        }
        //---------------------------------------------
        #endregion
